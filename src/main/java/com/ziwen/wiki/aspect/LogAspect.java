...
public class LogAspect {
    ...
    /** Define a Pointcut */
    @Pointcut("execution(public * com.ziwen.*.controller..*Controller.*(..))")
    ...
    public void doBefore(JoinPoint joinPoint) throws Throwable {
        ...
        LOG.info("Type Name: {}.{}", signature.getDeclaringTypeName(), name);
        ...
        LOG.info("Request: {}", JSONObject.toJSONString(arguments, excludefilter));
    }
